...
tryCatch(
    ...
    error = function(e) {
        cat("Aviso: Teste de Hosmer-Lemeshow não pode ser executado.\n")
        cat("Possível causa: poucos eventos de progressão ou falta de variação nas predi<U+00E7><U+00F5>es.\n")
        cat("Erro:", e$message, "\n")
    }
)
```
...
tryCatch(
    {
        ...
        if (internal_nodes > 0) {
            ...
            cat("Considere ajustar os hiperparâmetros ou aumentar o tamanho da amostra.\n\n")
